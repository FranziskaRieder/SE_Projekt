...
function addHtml(name, id) {
    ...
    span.insertAdjacentHTML('afterbegin', '<a href="#characterView" id="' + id + '" data-transition="fade" onClick="displayDataByKey(' + id + '), getKey(' + id + ')">' + name + '</a>')
    document.getElementById("CharakterUebersicht").appendChild(span); //display divs  
...
function addHtml2(name, age, gender, race, nat, h, hair, eyes, des) {
    ...
    overview.insertAdjacentHTML('afterbegin', '<div class="Header">' + name + '<a href="#Edit" data-transition="fade"><button class="edit" id="name" onclick="setNameFunction()" ><img id="smallEdit" src="img/bearbeitung.png"></button></a></div> <br><div id="Text2">Age: ' + age + ' <a href="#Edit" data-transition="fade"  ><button class="edit" onclick="setAgeFunction()" ><img id="smallEdit" src="img/bearbeitung.png" ></button></a></div><div id="Text2">Gender: ' + gender + ' <a href="#Edit" data-transition="fade" ><button class="edit" onclick="setGenderFunction()"><img id="smallEdit" src="img/bearbeitung.png"></button></a></div><div id="Text2">Race: ' + race + '  <a href="#Edit" data-transition="fade" ><button class="edit" onclick="setRaceFunction()"><img id="smallEdit" src="img/bearbeitung.png"></button></a></div><div id="Text2">Nationality: ' + nat + '  <a href="#Edit" data-transition="fade" ><button class="edit" onclick="setNatFunction()"><img id="smallEdit" src="img/bearbeitung.png"></button></a></div><div id="Text2">Heigth: ' + h + ' <a href="#Edit" data-transition="fade" ><button class="edit" onclick="sethFunction()"><img id="smallEdit" src="img/bearbeitung.png"></button></a></div><div id="Text2">Hair: ' + hair + ' <a href="#Edit" data-transition="fade" ><button class="edit" onclick="setHairFunction()"><img id="smallEdit" src="img/bearbeitung.png"></button></a></div><div id="Text2">Eyes: ' + eyes + ' <a href="#Edit" data-transition="fade" ><button class="edit" onclick="setEyesFunction()"><img id="smallEdit" src="img/bearbeitung.png"></button></a></div><div id="Text2" >Description: ' + des + '  <a href="#Edit" data-transition="fade" ><button class="edit" onclick="setDesFunction()"><img id="smallEdit" src="img/bearbeitung.png"></button></a></div>')
    document.getElementById("contentToRender").appendChild(overview);
}
/**
...
function addPics(name) {
    var span = document.createElement("span");
    span.insertAdjacentHTML('afterbegin', '<span><img id="myImage" src="'+name+'"></span>')
    document.getElementById("deviceready").appendChild(span); //display divs  
